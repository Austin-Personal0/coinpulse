...
const CandlestickChart = (
    { children , data , coinId , height = 360 , initialPeriod = 'daily' , liveInterval , setLiveInterval} : Partial<CandlestickChartProps>
) => {
    ...
    const fetchOhlcData = async ( selectedPeriod : Period ) => {
        try {
            ...
            const data = await fetcher<OHLCData[]>('GET' , `/coins/${coinId}/ohlc`, {
                vs_currency: 'usd',
                days,
                precision: 'full'
            })
